function [cartd1, xsj] = shpg_3d(shp,xl,nel)
%      
...
%     Compute derivatives with repect to global coords.
      ...
      for k = 1:nel
          d1 = shp(1,k)*rxs(1,1) + shp(2,k)*rxs(1,2) + shp(3,k)*rxs(1,3);
          d2 = shp(1,k)*rxs(2,1) + shp(2,k)*rxs(2,2) + shp(3,k)*rxs(2,3);
          d3 = shp(1,k)*rxs(3,1) + shp(2,k)*rxs(3,2) + shp(3,k)*rxs(3,3);
          cartd1(1,k) = d1;
          cartd1(2,k) = d2;
          cartd1(3,k) = d3;
          cartd1(4,k) = shp(4,k);
